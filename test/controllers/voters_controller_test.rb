...
class VotersControllerTest < ActionController::TestCase
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post :create, voter: { address: @voter.address, cnp: @voter.cnp, first_name: @voter.first_name, last_name: @voter.last_name, user_id: @voter.user_id, zone: @voter.zone }
    end
  ...
  test "should update voter" do
    patch :update, id: @voter, voter: { address: @voter.address, cnp: @voter.cnp, first_name: @voter.first_name, last_name: @voter.last_name, user_id: @voter.user_id, zone: @voter.zone }
    assert_redirected_to voter_path(assigns(:voter))
  end
